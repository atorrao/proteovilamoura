...
export default function Programme() {
  ...
  return (
    <div className="container">
      ...
      <div style={{ textAlign:'center', padding:'32px 0 28px', marginBottom:8 }}>
        <img
        ...
        />
        <div style={{ fontSize:'0.74rem', fontWeight:700, letterSpacing:'0.12em', textTransform:'uppercase', color:'var(--accent2)', marginBottom:8 }}>
          20–22 May 2026 · Vilamoura, Portugal
        </div>
        <p style={{ color:'var(--muted)', maxWidth:520, margin:'0 auto', fontSize:'0.88rem' }}>
            ...
            return (
              <div key={idx} style={{ background: happening?'rgba(34,197,94,0.06)':'var(--card)',
                ...
                <div style={{ padding:'14px 18px', display:'flex', alignItems:'flex-start', gap:12, flexWrap:'wrap' }}>
                  ...
                  <span style={{ fontSize:'0.7rem', fontWeight:700, padding:'2px 7px', borderRadius:6,
                  ...
                  <div style={{ borderTop:'1px solid var(--border)' }}>
                    {talks.map((t, ti) => (
                      <div key={ti} style={{ padding:'10px 18px', display:'flex', gap:10, alignItems:'flex-start', borderBottom: ti<talks.length-1?'1px solid rgba(22,64,85,0.4)':'none' }}>
                        ...
                        {t.type && (
                          <span style={{ fontSize:'0.66rem', fontWeight:700, padding:'1px 5px', borderRadius:5, textTransform:'uppercase', flexShrink:0,
