  ...
  wed: {
    ...
    afternoon: [
      ...
      { time: '17:15–18:10', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec1', talks: [
        ...
        { time: '17:23–17:27', title: 'DIV Matters: Understanding Proteomic Shifts in Neuronal Maturation for Better Ischemic Modeling', author: 'Eva Maria Ferro Abril Monteiro', type: 'flash', id: 118 },
      ]},
      { time: '17:27–17:35', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec2', talks: [
        { time: '17:27–17:31', title: 'When One is Enough: A Minimalistic "On-Pot" Proteomic Workflow for Global Profiling of Single Caenorhabditis elegans', author: 'Ibon Iloro Manzano', type: 'flash', id: 115 },
        { time: '17:31–17:35', title: 'Scaling-up low input spatial proteomics using Evosep Whisper Zoom on the timsTOF Ultra AIP', author: 'Beatriz Rocha Loureda', type: 'flash', id: 315 },
      ]},
      { time: '17:35–17:43', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec3', talks: [
        { time: '17:35–17:39', title: 'In-depth serum glycoproteomics reveals stage-dependent a2,6-sialylation and systemic prothrombotic signalling in gastric cancer', author: 'Lisandra Gabriela Fernandes Cruz', type: 'flash', id: 311 },
        { time: '17:39–17:43', title: 'Comprehensive nucleolar proteome profiling reveals metastasis-associated remodeling in colorectal cancer', author: 'Elisa Carral Ibarra', type: 'flash', id: 310 },
      ]},
  ...
  thu: {
    ...
    afternoon: [
      ...
      { time: '18:30–18:38', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec5', talks: [
        { time: '18:30–18:34', title: 'Multi-omics characterization of SIRT3 metabolism and its adaptation to the presence of amyloid-beta oligomers in nasal epithelial cells', author: 'Paz Cartas Cejudo', type: 'flash', id: 312 },
        { time: '18:34–18:38', title: 'Phenotypic remodelling of smooth muscle cells in atherosclerosis: a low-input and single-cell proteomics approach', author: 'David del Rio Aledo', type: 'flash', id: 112 },
      ]},
      { time: '18:38–18:42', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec6', talks: [
        { time: '18:38–18:42', title: 'From Microbes to Ecosystems: Proteomic Insights into Agro-Environmental Interactions', author: 'Francisco Javier Fernandez Acero', type: 'flash', id: 117 },
      ]},
      { time: '18:42–18:50', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec7', talks: [
        ...
        { time: '18:46–18:50', title: 'BiasTracker: a bioinformatics tool for quantifying physicochemical and functional biases in mass spectrometry-based proteomics', author: 'Gaelle Loutfi', type: 'flash', id: 113 },
      ]},
      { time: '18:50–18:58', kind: 'flash', title: 'Flash Presentations', sectionKey: 'sec8', talks: [
        ...
        { time: '18:54–18:58', title: 'MALDI-MSI as a Platform for Spatial Multi-Omics in Glioblastoma Research', author: 'Cristina María López Vázquez', type: 'flash', id: 114 },
      ]},
