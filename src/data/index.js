...
export const POSTERS = [
  { posterNum: 'F01.01', title: 'In depth-analysis of Alzheimer\'s disease brain tissue reveals novel Aβ interactors', author: 'Ana Montero Calle', type: 'poster', id: 501, sectionKey: 'sec1' },
  { posterNum: 'F01.02', title: 'Proteomic and functional characterization of SLC8A1 in colorectal cancer development and metastasis', author: 'Sara Batuecas Domínguez', type: 'poster', id: 502, sectionKey: 'sec1' },
  { posterNum: 'F01.03', title: 'DIV Matters: Understanding Proteomic Shifts in Neuronal Maturation for Better Ischemic Modeling', author: 'Eva Maria Ferro Abril Monteiro', type: 'poster', id: 503, sectionKey: 'sec1' },
  { posterNum: 'F01.04', title: 'In-depth serum glycoproteomics reveals stage-dependent a2,6-sialylation and systemic prothrombotic signalling in gastric cancer', author: 'Lisandra Gabriela Fernandes Cruz', type: 'poster', id: 504, sectionKey: 'sec3' },
  { posterNum: 'F01.05', title: 'Comprehensive nucleolar proteome profiling reveals metastasis-associated remodeling in colorectal cancer', author: 'Elisa Carral Ibarra', type: 'poster', id: 505, sectionKey: 'sec3' },
  { posterNum: 'F01.06', title: 'When One is Enough: A Minimalistic \"On-Pot\" Proteomic Workflow for Global Profiling of Single Caenorhabditis elegans', author: 'Ibon Iloro Manzano', type: 'poster', id: 506, sectionKey: 'sec2' },
  { posterNum: 'F01.07', title: 'Scaling-up low input spatial proteomics using Evosep Whisper Zoom on the timsTOF Ultra AIP', author: 'Beatriz Rocha Loureda', type: 'poster', id: 507, sectionKey: 'sec2' },
  { posterNum: '01.08', title: 'Analysis of the involvement of GLG1 and BAIAP2 in colorectal cancer by functional proteomics', author: 'Ana García Romero', type: 'poster', id: 508, sectionKey: 'sec1' },
  { posterNum: '01.09', title: 'Proteomic differences between high- and low-grade medullary thyroid carcinomas', author: 'Alberto Peláez García', type: 'poster', id: 509, sectionKey: 'sec1' },
  { posterNum: '01.10', title: 'Functional proteomics characterization of neurochondrin in colorectal cancer', author: 'María Garranzo Asensio', type: 'poster', id: 510, sectionKey: 'sec1' },
  { posterNum: '01.11', title: 'Discovery of protein biomarkers for the diagnosis of Equine Metabolic Syndrome', author: 'Elisa Mª Espinosa López', type: 'poster', id: 511, sectionKey: 'sec1' },
  { posterNum: '01.12', title: 'Molecular signatures of Macrophage-to-foam cell transition induced by dyslipidemic and atherosclerotic serum', author: 'Jorge Cabañas Penagos', type: 'poster', id: 512, sectionKey: 'sec1' },
  { posterNum: '01.13', title: 'Functional characterization of the mitochondrial protein NDUFAF4 and implications in cholestasis', author: 'Américo Cerqueira Mateo', type: 'poster', id: 513, sectionKey: 'sec1' },
  { posterNum: '01.14', title: 'Advancing Plasma Proteomics Through a Next-Generation Single-Particle Enrichment Workflow for Deeper and More Quantitative Biomarker Discovery', author: 'Karin Yeoh', type: 'poster', id: 514, sectionKey: 'sec1' },
  { posterNum: '01.15', title: 'Secretomic profiling of triple-negative breast cancer media using Mag-Net™ HP', author: 'Previn Naicker', type: 'poster', id: 515, sectionKey: 'sec2' },
  { posterNum: '01.16', title: 'QuickFit DualStream: A plug-and-play dual-column ion source for high-throughput proteomics', author: 'Adolfo Fernandez Gomez de Enterria', type: 'poster', id: 516, sectionKey: 'sec2' },
  { posterNum: '01.17', title: 'Spatial single-cell proteomics on routine Papanicolaou-stained liquid-based cervical cytology', author: 'Laura Cantero González-Salazar', type: 'poster', id: 517, sectionKey: 'sec2' },
  { posterNum: 'F02.18', title: 'Beyond Acquisition: Turning Astral-ScaleData into Discovery: A modular GUI for DIA Proteomics Analysis in a Core Facility', author: 'Marta Isasa', type: 'poster', id: 518, sectionKey: 'sec4' },
  { posterNum: 'F02.19', title: 'Optimizing tissue disruption strategies to characterize in vivo subcellular proteome remodelling', author: 'María Cinta Picos Mora', type: 'poster', id: 519, sectionKey: 'sec4' },
  { posterNum: '02.20', title: 'Plasma proteomic biomarkers of Hutchinson–Gilford progeria syndrome: evidence from a mouse model', author: 'Inés Perales Sánchez', type: 'poster', id: 520, sectionKey: 'sec3' },
  { posterNum: '02.21', title: 'Exploring the molecular link between aortic stenosis and chronic kidney disease through DIA-PASEF-based plasma proteomics', author: 'Laura Mourino-Alvarez', type: 'poster', id: 521, sectionKey: 'sec3' },
  { posterNum: '02.22', title: 'Unique high-throughput workflow for deeper plasma/serum proteome coverage enables discovery of potential biomarkers', author: 'Ann-Christine König', type: 'poster', id: 522, sectionKey: 'sec3' },
  { posterNum: '02.23', title: 'Integrated serum proteomics and autoantibody profiling reveal a protein signature predictive of flare in rheumatoid arthritis during biologic tapering', author: 'Cristina Ruiz-Romero', type: 'poster', id: 523, sectionKey: 'sec3' },
  { posterNum: '02.24', title: 'CSF proteomic profiling for biomarker identification in patients with MCI', author: 'Daniela Araújo', type: 'poster', id: 524, sectionKey: 'sec3' },
  { posterNum: '02.25', title: 'Proteomic pathway alterations in mouse hippocampus and prefrontal cortex following chronic citalopram treatment', author: 'Verônica Techmeier Morato', type: 'poster', id: 525, sectionKey: 'sec3' },
  { posterNum: '02.26', title: 'Organ-specific proteomic response to semaglutide treatment in healthy mice', author: 'Lucía Beltrán Camacho', type: 'poster', id: 526, sectionKey: 'sec3' },
  { posterNum: '02.27', title: 'ML-Driven Clinical-Proteomics Identifies a 6-Protein Signature for Precise Atherosclerosis Stratification', author: 'MªCarmen Durán Ruiz', type: 'poster', id: 527, sectionKey: 'sec3' },
  { posterNum: '02.28', title: 'Proteomic landscape of the PBMCs from diabetic patients with and without diabetic complications: preliminary results', author: 'Josefa Benítez Camacho', type: 'poster', id: 528, sectionKey: 'sec3' },
  { posterNum: '02.29', title: 'Analysis of Plasma Depleted Samples for Chronic Diseases\' Biomarker Discovery with the Orbitrap Astral Mass Spectrometer', author: 'Rodrigo Barderas', type: 'poster', id: 529, sectionKey: 'sec3' },
  { posterNum: '02.30', title: 'Phenotypic characterization of breast cancer cells using stochastic proteomic profiling', author: 'Kamami Sarah', type: 'poster', id: 530, sectionKey: 'sec3' },
  { posterNum: '02.31', title: 'Novel Insights into Red Blood Cell Dysregulation in Obstructive Sleep Apnea: a multi-omic approach', author: 'Sofia Maria Sentieiro Neves', type: 'poster', id: 531, sectionKey: 'sec3' },
  { posterNum: '02.32', title: 'Pathophysiological subtypes of mild cognitive impairment due to Alzheimer\'s disease identified by CSF proteomics', author: 'Bruno Manadas', type: 'poster', id: 532, sectionKey: 'sec3' },
  { posterNum: '02.33', title: 'Changes at salivary proteomic level elicited by exposure to food odorants', author: 'Carla Sofia da Silva Simões', type: 'poster', id: 533, sectionKey: 'sec3' },
  { posterNum: '02.34', title: 'Proteome-Informed Therapeutic Prioritisation for Patient-Specific Prescriptomics in Muscle-Invasive Bladder', author: 'João de Matos Reis Aleixo Montes', type: 'poster', id: 534, sectionKey: 'sec3' },
  { posterNum: 'F03.35', title: 'Multi-omics characterization of SIRT3 metabolism and its adaptation to the presence of amyloid-beta oligomers in nasal epithelial cells', author: 'Paz Cartas Cejudo', type: 'poster', id: 535, sectionKey: 'sec5' },
  { posterNum: 'F03.36', title: 'Phenotypic remodelling of smooth muscle cells in atherosclerosis: a low-input and single-cell proteomics approach', author: 'David del Rio Aledo', type: 'poster', id: 536, sectionKey: 'sec5' },
  { posterNum: 'F03.37', title: 'From Microbes to Ecosystems: Proteomic Insights into Agro-Environmental Interactions', author: 'Francisco Javier Fernandez Acero', type: 'poster', id: 537, sectionKey: 'sec6' },
  { posterNum: '03.39', title: 'High-sensitivity N-glycopeptide identification in human plasma using electron-activated dissociation', author: 'Javier Lago Nuñez', type: 'poster', id: 538, sectionKey: 'sec5' },
  { posterNum: '03.40', title: 'Fast and robust phosphoproteomics sample prep with AttractSPE® Disks C18 Tips for high phosphopeptide recovery and identification', author: 'Michel Arotcarena', type: 'poster', id: 539, sectionKey: 'sec5' },
  { posterNum: '03.41', title: 'Small-molecule post-translational modification in Chlamydomonas reinhardtii', author: 'Víctor García-Riaño Domínguez', type: 'poster', id: 540, sectionKey: 'sec5' },
  { posterNum: '03.42', title: 'Comparison of Strategies for Global Glycoprotein Profiling by LC-MS', author: 'Javier Beaskoetxea Lejarzegi', type: 'poster', id: 541, sectionKey: 'sec5' },
  { posterNum: '03.43', title: 'Sequential analysis of differential protein abundance, glycosylation and phosphorylation in WNT7A overexpressing MDA231 cells', author: 'Mikel Azkargorta', type: 'poster', id: 542, sectionKey: 'sec5' },
  { posterNum: '03.44', title: 'Exploring glycosylation alterations during atherosclerosis progression', author: 'Emilio Camafeita', type: 'poster', id: 543, sectionKey: 'sec5' },
  { posterNum: '03.45', title: 'Preconditioning therapy prevents site-specific oxidation of Trp/Cys redox sensors in contractile and metabolic cardiac proteins', author: 'Inmaculada Jorge Cerrudo', type: 'poster', id: 544, sectionKey: 'sec5' },
  { posterNum: '03.46', title: 'VPS4A validation as a Parkin substrate', author: 'Ainhoa Atxa Espiga', type: 'poster', id: 545, sectionKey: 'sec5' },
  { posterNum: '03.47', title: 'Metaproteomics in an Archaeological Environment: A Pipeline for Deciphering Ancient Remains', author: 'María Luz Valero Rustarazo', type: 'poster', id: 546, sectionKey: 'sec6' },
  { posterNum: '03.48', title: 'Seasonal protein variations of wild boar meat', author: 'Miguel Angel Sentandreu', type: 'poster', id: 547, sectionKey: 'sec6' },
  { posterNum: '03.49', title: 'Tracking 10 Stages of a Fruit Fly\'s Life Cycle with High-Throughput Proteomics', author: 'Iraide Escobés Corcuera', type: 'poster', id: 548, sectionKey: 'sec6' },
  { posterNum: '03.50', title: 'Secretome analysis to understand the intracellular traffic networks in fungi', author: 'Silvia Rodríguez Pires', type: 'poster', id: 549, sectionKey: 'sec6' },
  { posterNum: 'F04.51', title: 'Extending Proteome Profiling to Red Blood Cells using an Aptamer Platform', author: 'Luis André Botelho de Carvalho', type: 'poster', id: 550, sectionKey: 'sec7' },
  { posterNum: 'F04.52', title: 'BiasTracker: a bioinformatics tool for quantifying physicochemical and functional biases in mass spectrometry-based proteomics', author: 'Gaelle Loutfi', type: 'poster', id: 551, sectionKey: 'sec7' },
  { posterNum: 'F04.53', title: 'Comparative HLA-DR immunopeptidomics reveals disease- and genotype-associated signatures in rheumatoid arthritis', author: 'Jaxaira Maggi', type: 'poster', id: 552, sectionKey: 'sec8' },
  { posterNum: 'F04.54', title: 'MALDI-MSI as a Platform for Spatial Multi-Omics in Glioblastoma Research', author: 'Cristina María López Vázquez', type: 'poster', id: 553, sectionKey: 'sec8' },
  { posterNum: '04.55', title: 'Plasma Proteome Equalization Uncovers Dysregulated Proteostasis and Amyloidogenic Pathways in Multiple Myeloma', author: 'Inês de Freitas Domingos', type: 'poster', id: 554, sectionKey: 'sec7' },
  { posterNum: '04.56', title: 'Towards the Development of a Liquid Chromatography Free Workflow for Measurement of Clinically Important Proteins', author: 'Pierre-Olivier Schmit', type: 'poster', id: 555, sectionKey: 'sec7' },
  { posterNum: '04.57', title: 'Universal pipeline unlocking inter taxonomic differential abundance analyses: Brain matrisome characterization across mouse, ferret and human', author: 'Gianluca Arauz Garofalo', type: 'poster', id: 556, sectionKey: 'sec7' },
  { posterNum: '04.58', title: 'Proteomic Signatures Rescued by Two Candidate Molecules in a Zebrafish Model of CDKL5 Deficiency Disorder', author: 'Márcio Alexandre Filipe Simão', type: 'poster', id: 557, sectionKey: 'sec7' },
  { posterNum: '04.59', title: 'Label Free Quantitative Proteomics reveals MAM remodeling and inmunometabolic adaptation in LPS-activated Microglia', author: 'Vivian de los Ríos Benítez', type: 'poster', id: 558, sectionKey: 'sec7' },
  { posterNum: '04.60', title: 'Quantitative DIA-PASEF proteomic profiling reveals molecular alterations in a murine model of retinopathy of prematurity', author: 'Viviane de Almeida Bastos', type: 'poster', id: 559, sectionKey: 'sec7' },
  { posterNum: '04.61', title: 'Kuiper enables effective, fast and reliable library-free analysis of DIA Immunopeptidomics data', author: 'Jorge Peinado-Izaguerri', type: 'poster', id: 560, sectionKey: 'sec7' },
  { posterNum: '04.62', title: 'Ultrasound-Assisted Dental Peptidomics Reveals Integrated Host, Dietary, and Microbial Signatures', author: 'Raquel Inês Oliveira Lourenço da Fonseca', type: 'poster', id: 561, sectionKey: 'sec8' },
  { posterNum: '04.63', title: 'Exploring the proteomics capabilities of a new Trapped Ion Mobility Q-TOF designed for enhanced metabolomics performances', author: 'Pedro Cano', type: 'poster', id: 562, sectionKey: 'sec8' },
  { posterNum: '04.64', title: 'Red blood cell modulation in response to COVID-19 vaccination – A multiomics study', author: 'Joana Saraiva', type: 'poster', id: 563, sectionKey: 'sec8' },
]
