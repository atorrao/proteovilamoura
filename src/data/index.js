...
export const POSTERS = [
  ...
  { posterNum: '1.1', title: 'Functional proteomics characterization of neurochondrin in colorectal cancer', author: 'María Garranzo Asensio', type: 'poster', id: 510, sectionKey: 'sec1' },
  ...
  { posterNum: '2.2', title: 'Plasma proteomic biomarkers of Hutchinson–Gilford progeria syndrome: evidence from a mouse model', author: 'Inés Perales Sánchez', type: 'poster', id: 520, sectionKey: 'sec3' },
  ...
  { posterNum: '2.3', title: 'Phenotypic characterization of breast cancer cells using stochastic proteomic profiling', author: 'Kamami Sarah', type: 'poster', id: 530, sectionKey: 'sec3' },
  ...
  { posterNum: '3.39', title: 'High-sensitivity N-glycopeptide identification in human plasma using electron-activated dissociation', author: 'Javier Lago Nuñez', type: 'poster', id: 538, sectionKey: 'sec5' },
  { posterNum: '3.4', title: 'Fast and robust phosphoproteomics sample prep with AttractSPE® Disks C18 Tips for high phosphopeptide recovery and identification', author: 'Michel Arotcarena', type: 'poster', id: 539, sectionKey: 'sec5' },
  { posterNum: '3.41', title: 'Small-molecule post-translational modification in Chlamydomonas reinhardtii', author: 'Víctor García-Riaño Domínguez', type: 'poster', id: 540, sectionKey: 'sec5' },
  { posterNum: '3.42', title: 'Comparison of Strategies for Global Glycoprotein Profiling by LC-MS', author: 'Javier Beaskoetxea Lejarzegi', type: 'poster', id: 541, sectionKey: 'sec5' },
  { posterNum: '3.43', title: 'Sequential analysis of differential protein abundance, glycosylation and phosphorylation in WNT7A overexpressing MDA231 cells', author: 'Mikel Azkargorta', type: 'poster', id: 542, sectionKey: 'sec5' },
  { posterNum: '3.44', title: 'Exploring glycosylation alterations during atherosclerosis progression', author: 'Emilio Camafeita', type: 'poster', id: 543, sectionKey: 'sec5' },
  { posterNum: '3.45', title: 'Preconditioning therapy prevents site-specific oxidation of Trp/Cys redox sensors in contractile and metabolic cardiac proteins', author: 'Inmaculada Jorge Cerrudo', type: 'poster', id: 544, sectionKey: 'sec5' },
  { posterNum: '3.46', title: 'VPS4A validation as a Parkin substrate', author: 'Ainhoa Atxa Espiga', type: 'poster', id: 545, sectionKey: 'sec5' },
  { posterNum: '3.47', title: 'Metaproteomics in an Archaeological Environment: A Pipeline for Deciphering Ancient Remains', author: 'María Luz Valero Rustarazo', type: 'poster', id: 546, sectionKey: 'sec6' },
  { posterNum: '3.48', title: 'Seasonal protein variations of wild boar meat', author: 'Miguel Angel Sentandreu', type: 'poster', id: 547, sectionKey: 'sec6' },
  { posterNum: '3.49', title: 'Tracking 10 Stages of a Fruit Fly\'s Life Cycle with High-Throughput Proteomics', author: 'Iraide Escobés Corcuera', type: 'poster', id: 548, sectionKey: 'sec6' },
  { posterNum: '3.5', title: 'Secretome analysis to understand the intracellular traffic networks in fungi', author: 'Silvia Rodríguez Pires', type: 'poster', id: 549, sectionKey: 'sec6' },
  { posterNum: 'F4.51', title: 'Extending Proteome Profiling to Red Blood Cells using an Aptamer Platform', author: 'Luis André Botelho de Carvalho', type: 'poster', id: 550, sectionKey: 'sec7' },
  { posterNum: 'F4.52', title: 'BiasTracker: a bioinformatics tool for quantifying physicochemical and functional biases in mass spectrometry-based proteomics', author: 'Gaelle Loutfi', type: 'poster', id: 551, sectionKey: 'sec7' },
  { posterNum: 'F4.53', title: 'Comparative HLA-DR immunopeptidomics reveals disease- and genotype-associated signatures in rheumatoid arthritis', author: 'Jaxaira Maggi', type: 'poster', id: 552, sectionKey: 'sec8' },
  { posterNum: 'F4.54', title: 'MALDI-MSI as a Platform for Spatial Multi-Omics in Glioblastoma Research', author: 'Cristina María López Vázquez', type: 'poster', id: 553, sectionKey: 'sec8' },
  { posterNum: '4.55', title: 'Plasma Proteome Equalization Uncovers Dysregulated Proteostasis and Amyloidogenic Pathways in Multiple Myeloma', author: 'Inês de Freitas Domingos', type: 'poster', id: 554, sectionKey: 'sec7' },
  { posterNum: '4.56', title: 'Towards the Development of a Liquid Chromatography Free Workflow for Measurement of Clinically Important Proteins', author: 'Pierre-Olivier Schmit', type: 'poster', id: 555, sectionKey: 'sec7' },
  { posterNum: '4.57', title: 'Universal pipeline unlocking inter taxonomic differential abundance analyses: Brain matrisome characterization across mouse, ferret and human', author: 'Gianluca Arauz Garofalo', type: 'poster', id: 556, sectionKey: 'sec7' },
  { posterNum: '4.58', title: 'Proteomic Signatures Rescued by Two Candidate Molecules in a Zebrafish Model of CDKL5 Deficiency Disorder', author: 'Márcio Alexandre Filipe Simão', type: 'poster', id: 557, sectionKey: 'sec7' },
  { posterNum: '4.59', title: 'Label Free Quantitative Proteomics reveals MAM remodeling and inmunometabolic adaptation in LPS-activated Microglia', author: 'Vivian de los Ríos Benítez', type: 'poster', id: 558, sectionKey: 'sec7' },
  { posterNum: '4.6', title: 'Quantitative DIA-PASEF proteomic profiling reveals molecular alterations in a murine model of retinopathy of prematurity', author: 'Viviane de Almeida Bastos', type: 'poster', id: 559, sectionKey: 'sec7' },
  { posterNum: '4.61', title: 'Kuiper enables effective, fast and reliable library-free analysis of DIA Immunopeptidomics data', author: 'Jorge Peinado-Izaguerri', type: 'poster', id: 560, sectionKey: 'sec7' },
  { posterNum: '4.62', title: 'Ultrasound-Assisted Dental Peptidomics Reveals Integrated Host, Dietary, and Microbial Signatures', author: 'Raquel Inês Oliveira Lourenço da Fonseca', type: 'poster', id: 561, sectionKey: 'sec8' },
  { posterNum: '4.63', title: 'Exploring the proteomics capabilities of a new Trapped Ion Mobility Q-TOF designed for enhanced metabolomics performances', author: 'Pedro Cano', type: 'poster', id: 562, sectionKey: 'sec8' },
  { posterNum: '4.64', title: 'Red blood cell modulation in response to COVID-19 vaccination – A multiomics study', author: 'Joana Saraiva', type: 'poster', id: 563, sectionKey: 'sec8' },
]
