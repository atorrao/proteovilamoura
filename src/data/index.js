...
export const PROGRAMME = {
  wed: {
    ...
    morning: [
      { time: '9:30–12:00', kind: 'special', title: 'Pre-congress course: Practical Introduction to Python Programming — Diego Mena Santos · Samuel Lozano Juárez', talks: [] },
      { time: '11:00–13:00', kind: 'break', title: 'Registration', talks: [] },
      { time: '13:00–13:15', kind: 'special', title: 'Welcoming Session', talks: [] },
      { time: '13:15–13:45', kind: 'invited', title: 'Invited Speaker — Nelson Soares — Proteomics profiling of Red Blood Cells combined with Deep Machine Learning analysis', talks: [] },
    ],
    afternoon: [
      ...
      { time: '16:15–17:15', kind: 'section', title: 'Section 2 — Next-Gen Proteomics: Single-Cell, Proteogenomics & Disruptive Technologies', sectionKey: 'sec2', talks: [
        ...
        { time: '16:30–16:45', title: 'Sponsor Oral Communication', author: '', type: 'oral', id: 107 },
        ...
        { time: '17:00–17:15', title: 'Sponsor Oral Communication', author: '', type: 'oral', id: 109 },
      ]},
  ...
  thu: {
    ...
    morning: [
      ...
      { time: '8:00–8:30', kind: 'special', title: 'Sponsor Session', talks: [] },
      ...
      { time: '9:00–10:15', kind: 'section', title: 'Section 3 — Proteomics in the Clinic: From Biomarkers to Precision Medicine #2', sectionKey: 'sec3', talks: [
        ...
        { time: '9:30–9:45', title: 'Narrow-Window Scanning DIA: Redefining Selectivity and Quantitative Confidence (Sponsor — SCIEX)', author: 'SCIEX', type: 'oral', id: 203 },
    ...
    afternoon: [
      ...
      { time: '13:30–14:00', kind: 'special', title: 'Sponsor Session — Bruker (Rafaelo Room)', talks: [] },
      { time: '14:00–14:30', kind: 'special', title: 'Sponsor Session — Thermo/Unicam (Rafaelo Room)', talks: [] },
      ...
      { time: '17:15–18:30', kind: 'section', title: 'Section 6 — Proteomics Exploration in Non-Model Systems', sectionKey: 'sec6', talks: [
        ...
        { time: '17:45–18:00', title: 'Sponsor Oral Communication', author: '', type: 'oral', id: 307 },
        { time: '18:00–18:15', title: 'Proteomic characterization of baculovirus expression vector system (BEVS)-derived extracellular vesicles engineered for Gla-Rich Protein (GRP) γ-carboxylation', author: 'Carla Alexandra São Bento Viegas', type: 'oral', id: 308 },
      ...
      { time: '18:30–19:02', kind: 'flash', title: 'Flash Presentations — Section 6', sectionKey: 'sec6', talks: [
        ...
        { time: '18:54–18:58', title: 'Scaling-up low input spatial proteomics using Evosep Whisper Zoom on the timsTOF Ultra AIP', author: 'Beatriz Rocha Loureda', type: 'flash', id: 315 },
        { time: '18:58–19:02', title: 'Optimizing tissue disruption strategies to characterize in vivo subcellular proteome remodelling', author: 'María Cinta Picos Mora', type: 'flash', id: 316 },
      ]},
  ...
  fri: {
    ...
    morning: [
      ...
      { time: '9:00–10:15', kind: 'section', title: 'Section 7 — Quantitative and Computational Proteomics', sectionKey: 'sec7', talks: [
        ...
        { time: '9:30–9:45', title: 'Sponsor Oral Communication — Thermo #2', author: '', type: 'oral', id: 403 },
